    ...
    <div style={{ minHeight: '100vh', background: '#0B3D2E', paddingBottom: 80 }}>
      ...
      <div style={{ 
        ...
        <div style={{ maxWidth: 640, margin: '0 auto', display: 'flex', gap: 12 }}>
           ...
           >
             {sending ? <Loader2 size={20} style={{ animation: 'spin 1s linear infinite', width: '20px', height: '20px' }} color="#0B3D2E" /> : <SendHorizontal size={20} color="#0B3D2E" style={{ width: '20px', height: '20px' }} />}
           </button>
        </div>
      </div>
    </div>
